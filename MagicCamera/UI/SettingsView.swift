    ...
    private var diagnosticsSection: some View {
        Section {
            ...
            if #available(iOS 18.0, *) {
                Toggle("RealityKit preview", isOn: $settings.realityKitPreview)
                    .tint(Theme.accent)
            }
